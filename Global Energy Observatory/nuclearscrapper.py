...
while count <66:
    ...
    try:
        ...
        type = browser.find_element_by_xpath('//*[@id="Type"]/option[5]')
        type.click()
        time.sleep(3)
        ...
        with open('Nuclear.csv', 'a', newline='') as file:

            headers = ['Name', 'Country', 'Status', 'Latitude', 'Longitude', 'Design Capacity', 'Plant Type', 'Location', 'Power Grid', 'Owner', 'Per Owner', 'Ownership Type', 'EPC Contractor', 'Operating Company', 'Regulatory Authority', 'Financed By', 'Reference']
            ...
            try:
                ...
                plant_type_dropdown = browser.find_element_by_xpath('//*[@id="Type_of_Reactors_enumfield_rng1"]')
