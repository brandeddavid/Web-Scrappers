...
while count < 191:
    ...
    try:
        ...
        type = browser.find_element_by_xpath('//*[@id="Type"]/option[4]')
        type.click()
        time.sleep(3)
        ...
        with open('Hydro.csv', 'a', newline='') as file:

            headers = ['Name', 'Country', 'Status', 'Latitude', 'Longitude', 'Design Capacity', 'Plant Type', 'Plant Use', 'Location', 'Power Grid', 'Water Source', 'Year Commissioned', 'Owner', 'Per Owner', 'Ownership Type', 'EPC Contractor', 'Operating Company', 'Regulatory Authority', 'Financed By','Reference']
            ...
            try:
                ...
                water_source = browser.find_element_by_xpath('//*[@id="River/Lake/Canal_Dammed"]').get_attribute('value')
                #print(water_source)
