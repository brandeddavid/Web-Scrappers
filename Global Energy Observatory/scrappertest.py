    ...
    try:
        ...
        for count in range(1):
            ...
            try:
                ...
                country = browser.find_element_by_xpath('//*[@id="Country"]/option['+str(countrycount)+']')
                ...
                with open('Geothermal Plants.csv', 'a', newline='') as file:
                    ...
                    plant = browser.find_element_by_xpath('//*[@id="Name"]/option[' + str(count+1) + ']')
                    plant.click()
                    time.sleep(3)
